...
Отправили: \(x_1; f(x_1)\)\\
Пришло: \(x'_1 = x_1 \bigoplus x', x' \in D_0; f_{x_1} = f(x_1)\),
...
Пришло:
\(x'_1 = x_1 \bigoplus x'_a \bigoplus x'_b: x'_a, x'_b \in D_0; f_{x_1} = f(x_1)\),
...
Работают только «в движении». Вспоминаем школьную физику!
...
\item
  ...
  \item
    Скорость выше, чем у бумажной
  \item
    Сейчас используется для бэкапа и хранения значительных объёмов данных,
    кассеты \href{https://en.wikipedia.org/wiki/Linear\_Tape-Open\#Key\_specifications}{на десятки Тб}
    стоят единицы тыс. руб.
  \end{itemize}
\item
  Барабан
...
устройства, \href{\ytlink{pmfHHLfbjNQ}}{можно воспроизводить звук}
\end{frame}
...
\begin{frame}{НищеRAID}
    ...
    \begin{itemize}
    \item \href{\ytlink{dougISKs2vQ}}{Из настоящих флешек}
    \item \href{\ytlink{Uxj7So3h-lw}}{Из дисководов с дискетами}
    \end{itemize}
\end{frame}
