...
\begin{frame}{Закон Ома}
    \begin{figure}
        \includegraphics[height=0.75\textheight]{img/\jobname/Ohm_Law.jpg}
    \end{figure}
    $$U = IR$$
\end{frame}
...
\begin{itemize}
    \item \href{\ytlink{EzyXMEpq4qw}}{Немного викторианского духа в наши дни}
\end{itemize}
...
\begin{block}{Полупроводниковые диод и транзисторы}
    \begin{outline}[itemize]
        \1 \href{\ytlink{OMGdSCaMVD0}}{Как полупроводниковый диод и биполярный транзистор умудряются работать?..}
            \2 \href{https://www.falstad.com/circuit/e-npn.html}{Симулятор биполярного NPN-транзистора}
        \1 \href{\ytlink{ZUly6Wz0RHc}}{Как умудряется работать полевой транзистор?..}
...
\begin{block}{Немного духа}
    \begin{itemize}
        \item \href{\ytlink{DEewNHWgqFU}}{Немного духа 1960-х}
    \end{itemize}
\end{block}
\end{frame}
...
\begin{figure}
    \includegraphics[width=1\textwidth]{img/\jobname/gates_IEC.png}
    \caption{IEC / ГОСТ}
\end{figure}


\begin{figure}
    \includegraphics[width=1\textwidth]{img/\jobname/gates_ANSI.png}
    \caption{ANSI}
\end{figure}
...
\item
  ...
  пневмоавтоматики}
\item
  \href{https://habr.com/ru/company/ruvds/blog/695210/}{Пневмоника} (в т.ч. \href{\ytlink{yvANcR4mQ7M}}{самодельная})
\item
  \href{http://www.robives.com/category/product_tags/logic_goats}{Логические козлы}

  \begin{itemize}
  \item
    \href{\ytlink{vu3o6JNclRQ}}{В действии}
  \end{itemize}
\end{itemize}
\end{frame}
...
\begin{frame}{Отрицание «с переключением»}
    \begin{figure}
        \includegraphics[height=0.5\textheight]{img/\jobname/not_switch.pdf}
...
\begin{frame}{Отрицание с согласующим резистором}
    \begin{figure}
        \includegraphics[height=0.5\textheight]{img/\jobname/not_resist.pdf}
...
\begin{frame}{Как оно работает? (1)}
    \begin{figure}
        \includegraphics[width=0.75\textwidth]{img/\jobname/R-R.pdf}
    \end{figure}
...
\begin{frame}{Как оно работает? (2)}
    \begin{figure}
    \includegraphics[width=0.9\textwidth]{img/\jobname/not_resist_physics.pdf}
...
\begin{frame}{Разные вентили}
    \begin{figure}
    \includegraphics[width=0.9\textwidth]{img/\jobname/transistor-gates.pdf}
    \end{figure}
