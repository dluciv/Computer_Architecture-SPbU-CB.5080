...
\begin{frame}{Конвейер}
    ...
    \end{block}
    \pause
    Т.е. у конвейера нет шансов остаться таким же простым, как, например, у MIPS.
    \href{https://stackoverflow.com/a/54725021}{Обсуждение на Stack Overflow}
    \pause
    \begin{block}{Пример: отечественные процессоры компании Syntacore}
        \begin{itemize}
            \tightlist
            \item \href{https://syntacore.ru/page/products/processor-ip/scr1}{Серия SCR1} --- для микроконтроллеров
            \item \ldots
            \item \href{https://syntacore.ru/page/products/processor-ip/scr7}{Серия SCR7} --- для серверов
        \end{itemize}
    \end{block}
\end{frame}
