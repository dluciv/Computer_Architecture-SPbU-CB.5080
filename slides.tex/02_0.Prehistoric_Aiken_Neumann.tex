...
\begin{frame}{История вычислительной техники до XIX века}
	...
	\begin{block}{XIX век}
		...
		\begin{column}{0.3\textwidth}
			\includegraphics[width=\textwidth]{img/\jobname/Ada_Byron_aged_seventeen_1832.jpg}
		\end{column}
		\end{columns}
	\end{block}
\end{frame}
...
\begin{frame}{1930-е -- 1940-е, <<Гарвардская>> (Эйкена) архитектура}
		...
		\begin{figure}
			\includesvg[height=0.5\textheight, inkscapelatex=false]{img/\jobname/Harvard.svg}
		\end{figure}
...
\begin{frame}{1940-е -- \ldots <<Принстонская>> (фон Неймана) архитектура}
	\begin{figure}
		\includesvg[height=0.5\textheight]{img/\jobname/Von_Neumann_Architecture.svg}
	\end{figure}
...
\begin{frame}{Системная шина фон Неймановских машин}
		\begin{figure}
			\includesvg[height=0.5\textheight]{img/\jobname/Von_Neumann_System_Bus.svg}
		\end{figure}
...
\begin{frame}{I поколение: 1940-е, в основном физические вычисления}
	...
	\begin{block}{Свойства}
		...
		несколько Гц. \href{\ytlink{5hhbGBlP3_4}}{Современный пример}
	\end{block}
...
\begin{frame}{Отечественные ЭВМ}
	\begin{itemize}
		...
		Лебедев
		\item
		1950-е -- 1970-е --- Сетунь (троичная, стековая) --- Н.П. Бруснецов
		\item
