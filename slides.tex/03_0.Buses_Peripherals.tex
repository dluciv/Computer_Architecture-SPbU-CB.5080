...
\begin{frame}{S-100, 1974}
    ...
    \begin{outline}[itemize]
        ...
        \1 Просто плата с разъёмами и стандарт, через какой контакт и какие дорожки что идёт (какие сигналы и какое питание); вполне буквально фон Неймановская системная шина
        \pause
